  ...
  .factory('builderService', ['applicationService', function (applicationService) {
      ...
      function handleLayout() {
          $('.layout-option input').on('click', function () {
              ...
              if(layout == 'sidebar-top' && is_checked == true) applicationService.createSidebarTop();
              if(layout == 'sidebar-top' && is_checked == false) applicationService.removeSidebarTop();
              ...
              if (layout == 'rtl' && is_checked == true) applicationService.enableRTL();
              if (layout == 'rtl' && is_checked == false) applicationService.disableRTL();
          });
      }
