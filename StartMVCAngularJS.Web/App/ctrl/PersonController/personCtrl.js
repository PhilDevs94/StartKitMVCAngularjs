'use strict';
angular.module('app')
    .controller('PersonCtrl', ['$scope', '$state', '$stateParams', '$http', 'toaster', '$timeout', function ($scope, $state, $stateParams, $http, toaster, $timeout){
    console.log('Person Controller');
    var vm = this;
    alert("hey i'm in please active me");
    vm.clickButton = clickButton;
    function clickButton(){
        alert("You clicked at me, please click it again and again");
    }
